...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderProductDTO addOrderProduct(OrderProductDTO orderProductDTO) {
        ...
        OrderProduct op = orderProductRepository.save(orderProduct);
        op.setProductByIdProduct(productRepository.findById(orderProductDTO.getProductDTO().getId()).get());
        return OrderProductMapper.toOrderProductDTO(op);
    }
